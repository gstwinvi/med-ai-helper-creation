  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                  <span className="text-medical-teal">Ассистент</span> для родителей
                </h1>
                ...
                <Button className="bg-medical-teal hover:bg-medical-blue text-white px-6 py-3 rounded-lg">
                  Начать консультацию
                </Button>
              </div>
              <div className="flex justify-center">
                <div className="relative">
                  <div className="rounded-full bg-medical-softgreen p-4 w-64 h-64 flex items-center justify-center">
                    <img 
              ...
              <Card className="p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start space-x-4">
                  <div className="p-3 rounded-full bg-green-100">
                    <Calendar className="h-8 w-8 text-medical-teal" />
                  </div>
                  <div className="flex-1">
                    ...
                    <Link to="/calendar" className="inline-flex items-center mt-3 text-medical-teal hover:text-medical-blue">
              ...
              <Card className="p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start space-x-4">
                  <div className="p-3 rounded-full bg-blue-100">
                    <LineChart className="h-8 w-8 text-medical-teal" />
                  </div>
                  <div className="flex-1">
                    ...
                    <Link to="/growth" className="inline-flex items-center mt-3 text-medical-teal hover:text-medical-blue">
                      Подробнее <ChevronRight className="h-4 w-4 ml-1" />
                    </Link>
                  </div>
                </div>
              ...
              <Card className="p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Link to="/symptoms" className="inline-flex items-center mt-3 text-medical-teal hover:text-medical-blue">
                      Подробнее <ChevronRight className="h-4 w-4 ml-1" />
                    </Link>
                  </div>
                </div>
              ...
              <Card className="p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Link to="/recommendations" className="inline-flex items-center mt-3 text-medical-teal hover:text-medical-blue">
                      Подробнее <ChevronRight className="h-4 w-4 ml-1" />
                    </Link>
                  </div>
                </div>
        ...
        <section className="bg-gradient-to-r from-medical-teal to-medical-blue py-12 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button className="bg-white text-medical-teal hover:bg-gray-100 px-6 py-3 rounded-lg">
              Спросить ассистента
            </Button>
          </div>
        </section>
